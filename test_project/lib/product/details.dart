...
class _ProductDetailsState extends State<ProductDetails> {
  ...
  Future<void> getDetailsProduct()async{
    ...
    var url=Uri.parse(base_url+'api/v1/shop/product/'+widget.id.toString(),);
    ...
    return Scaffold(
      body: Column(
        children: [
            ...
            child: SingleChildScrollView(
              child: Column(children: [
                CachedNetworkImage(
                  ...
                  fit: BoxFit.fill,
                  imageUrl: base_download_image+'product/'+product['product_attribute']['product_info']['images'][0]['imageName'],
                ),
                SizedBox(height: 15,),
                Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    for(var item in product['product_attribute']['product_info']['images'])
                    Padding(
                      ...
                      child: CachedNetworkImage(
                        ...
                        height: 60,
                        fit: BoxFit.fill,
                        imageUrl: base_download_image+'product/'+item['imageName'],
                      ),
                    ),
                  ],
                ),
          ...
          }, title: 'Add To Cart', loading: false)
        ],
      ),
    );
  }
